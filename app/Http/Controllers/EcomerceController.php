...
class EcomerceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('frontend.ecomerce', compact('products', 'categories', 'tags', 'keyword', 'selected_price', 'selected_category', 'selected_tags'));
    }
    function list(Request $request) {
        ...
        $products = $products->orderByDesc('id')->Paginate(9);
        return view('frontend.list', compact('products', 'categories', 'tags', 'keyword', 'selected_price', 'selected_category', 'selected_tags'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ecomerce.list')->with([
